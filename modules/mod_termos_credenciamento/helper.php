...
class ModTermosCredenciamento{
  	...
  	public function getDadosWebService($params) {
		...
		try {
			...
			$responseTermoCredenciamento = json_decode(json_encode($client->getTermoCredenciamento()), True);

			$dados["listaTermoCredenciamento"] = $responseTermoCredenciamento;
