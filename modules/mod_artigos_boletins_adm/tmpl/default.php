						...
						<table>
							...
							foreach($dados['listaBoletinsAdministrativos']['return'] as $listDados):
								if(!empty($listDados['dataPublicacao'])):
									...
									<tr>
										<td>
											<a href="#conteudo" onclick="exibirArquivo('gestao-orcamentaria/resultado-pdf', '<?php echo $listDados['id'] ;?>', 'SV27', '<?php echo urlencode('REVISTA GABINETE/BOLETINS ADMINISTRATIVOS/'.$listDados['descricao'])?>')"><?php echo $listDados['descricao'];?></a>
										</td>
