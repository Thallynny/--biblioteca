...
$dados = ModBuscaGuiadaBiblioteca::getDadosWebService($params, $arg0, $origem, $nivel);

require JModuleHelper::getLayoutPath('mod_busca_guiada_biblioteca', $params->get('layout', 'default'));
