                ...
                <div class="col-9 consultacontainer">
                    ...
                    <div class="box">
						...
						foreach($buscaGuiadaServico as $retorno){
							foreach($retorno->categoria as $botoes){
								if(is_object($botoes)){ ?>
								<div class="box" onclick="javascript:resultadoBuscaGuiada('<?php echo $botoes->path; ?>','biblioteca','<?php echo $botoes->nivel; ?>')";>
	...
	if($id_categoria == "resultado"){	?>	
			<div class="row">
                ...
                <div class="col-9 consultacontainer">
					...
					<div class="option margin">
                        <div class="chevron volta" onclick="javascript:resultadoBuscaGuiada('1','biblioteca','biblioteca')";><</div>
                        Escolha uma opção
                    </div>
