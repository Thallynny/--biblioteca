							...
							if($horarioAno2 == $horarioAno){
								if($mural['exibe']){
									$texto .= "<tr>
										...
										<td>".$mural['hora']."</td>
										<td>
											<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$mural['codigo']."', 'SV25', '".urlencode("PORTAL DOS SERVIÇOS PÚBLICOS/Mural Gabinete Desembargador Marcelo Navarro/".$horarioAno2."/".retiraBarras($mural['descricaoArquivo']))."')\">
