...
{
    $newOrigem = str_replace('concilicacao', 'Conciliação', $origem);
    return $newOrigem;
}
?>
                    ...
                    foreach ($retornos as $retorno) {
                        if (isset($retorno->categoria)) {
                            if (is_object($retorno->categoria)) {
                                ...
                                $link = str_replace("conciliacao/", "", $pesquisa->link); ?>
                                <li class="left w100">
                            ...
                            if (is_object($retorno->conteudo)) {
                                ...
                                <?php
                                    ...
                                    $link = str_replace("conciliacao/", "", $pesquisa->link); ?>
                                    <li class="left w100">
                                        <a class="box noborder" title="Link para <?php echo $pesquisa->title; ?>" href="<?php echo $link; ?>" <?php echo strpos($link, 'index.php/') ? '' : 'target="_blank"'; ?>>
                                            <?php echo getTitle($pesquisa->title); ?>
                                        </a>
                                    </li>
                                    <?php
