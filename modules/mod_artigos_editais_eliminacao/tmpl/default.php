                    ...
                    <tbody>
						...
						foreach ($list['editais'] as $listDados) :
							...
							if ($horarioAno2 == $horarioAno) :
								...
								$texto .= "
										<td>
										<a href='#conteudo' onclick=\"exibirArquivo('gestao-orcamentaria/resultado-pdf', '" . $listDados['codigo'] . "', 'SV24', '" . urlencode("EDITAIS DE ELIMINAÇÃO/" . $horarioAno2 . "/" . retiraBarras($listDados['descricaoArquivo'])) . "')\">
