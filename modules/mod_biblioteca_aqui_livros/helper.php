...
abstract class ModBibliotecaLivros
{
public function getList($params, $pagina, $limite) {
		...
		try {
			...
			$arguments = array('getNovaAquisicaoLivros' => array('limiteRegistro' => $limite, 'pagina' => $pagina));
			$limiteRegistro = $client->__soapCall("getNovaAquisicaoLivros", $arguments ); 
