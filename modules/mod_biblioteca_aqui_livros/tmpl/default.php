			...
			$totalArquivo = "";
			 ...
			 foreach($list['return'] as $atas){
              ...
              ?>
                 	<div class="col-sm-2">
					<?php
					echo "<a role='img' href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$atas['id']."', 'SV32', '".urlencode("BIBLIOTECA/Novas Aquisições/LIVROS/".$atas['nomeArquivo'])."')\">
