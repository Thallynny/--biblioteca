            ...
            ?>
                    <div class="row report">
                        <ul>
                            ...
                            <li class="arrow-down"><a href="#conteudo" role="button" title="Expandir ano de <?php echo $horarioAno[0]; ?>"><img src="templates/portalTRF5/images/arrow_down_2.svg" alt="Abrir conteúdo"></a></li>
                        </ul>
                    </div>
                    <div class="row botoes w100">
                        <a title="Baixar em PDF" href="#conteudo" role="button" class="download" onClick="javascript:baixarPDF(<?= $ano; ?>, 'pdf');">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            PDF
                        </a>
                        <a title="Baixar em XML" href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento(<?= $ano; ?>, 'xml');">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            XML
                        </a>
                        <a title="Baixar em CSV" href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento(<?= $ano; ?>, 'csv');">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            CSV
                        </a>
                        <a title="Imprimir" href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('tabela_export_<?= $ano; ?>', 'export', '', this);">
    ...
    <div class="row conteudo" data-aba-id="2">
        <div class="col-12">
            ...
            ?>
                    ...
                    <div class="row botoes w100">
                        <a href="#conteudo" role="button" class="download" title="Baixar em PDF" onClick="javascript:baixarPDF('2_<?= $ano; ?>');">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            PDF
                        </a>
                        <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('2_<?= $ano; ?>', 'xml');" title="Baixar em XML">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            XML
                        </a>
                        <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('2_<?= $ano; ?>', 'csv');" title="Baixar em CSV">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            CSV
                        </a>
    ...
    <div class="row conteudo selecionado">
        <div class="col-12">
            ...
            ?>
                    ...
                    <div class="row botoes w100">
                        <a href="#conteudo" role="button" class="download" title="Baixar em PDF" onClick="javascript:baixarPDF(<?= $ano; ?>);">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            PDF
                        </a>
                        <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento(<?= $ano; ?>, 'xml');" title="Baixar em XML">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            XML
                        </a>
                        <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento(<?= $ano; ?>, 'csv');" title="Baixar em CSV">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            CSV
                        </a>
        ...
        <div class="col-12">
            ...
            ?>
                    ...
                    <div class="row botoes w100">
                        ...
                        <a href="#conteudo" role="button" title="Imprimir" class="download" onClick="javascript:baixarDocumento('tabela2_export_<?= $ano; ?>', 'export', '', this);">
                            <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                            IMPRIMIR
                        </a>
                        <br>
...
?>
            ...
            <div class="row botoes w100">
                ...
                <a href="#conteudo" role="button" title="Imprimir" class="download">
                    <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                    IMPRIMIR
                </a>
                <br>
...
if ($group->category_alias == "participacoes-trf5-orgaos-participacoes") : ?>
    <div class="conteudo selecionado" data-aba-id="1">
        <div class="col-12">
            <div class="row">
            ...
            ?>
                    ...
                    <div class="row botoes w100">
                        ...
                        if($ano <= 2019){
                            ...
                            $texto = str_replace("<table ", "<table border=1 ", $texto);
                            $htmlPDF .= str_replace("<br />", "", $texto);
                            $htmlPDF .= "</table>";
                        }else{
                            $htmlPDF .= str_replace("<br />", "", $texto); 
...
if ($group->category_alias == "participacoes-trf5-orgaos-adesoes") : ?>
    <div class="row conteudo" data-aba-id="2">
        <div class="col-12">
            <div class="row">
                <div class="titulo">ADESÕES DE OUTROS ÓRGÃOS ÀS ARPS DO TRF5</div>
            </div>
            <div class="row">
                <small>Última atualização: <?php echo getDataAtualizacaoArtigo($list) ?></small>
            </div>
...
<!-- ADESÕES DO TRF5 EM OUTROS ÓRGÃOS-->
<?php
$ano = 0;
if ($group->category_alias == "atas-de-registro-de-preco-adesao") { ?>
    <div class="col-12">
        <div class="row">
            <div class="titulo">Adesões do TRF5 em Outros Orgãos</div>
        </div>
        <div class="row">
            <small>Última atualização: <?php echo getDataAtualizacaoArtigo($list) ?></small>
        </div>
        ...
        ?>
                <div class="row report">
                    <ul style="width: 20%">
                        ...
                        <li class="arrow-down"><a href="#conteudo" title="Expandir ano de <?= $ano; ?>"><img src="templates/portalTRF5/images/arrow_down_2.svg" width="34"></a></li>
                    </ul>
                </div>
                <div class="row botoes w100">
                    <div class="boxBotoes">
                        <a href="#conteudo" role="button" class="download" title="Baixar em PDF" onClick="javascript:baixarPDF('2_<?= $ano; ?>', 'pdf');">
                            <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                            PDF
                        </a>
                        <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('2_<?= $ano; ?>', 'xml');" title="Baixar em XML">
...
if ($group->category_alias == "licitacoes") : ?>
    ...
    ?>
            <div class="row report">
                <ul>
                    <li class="titulo" style="display: inline-block; width: 59px;"><?= $ano; ?></li>
                    <li class="arrow-down"><a href="#conteudo" role="button" title="Expandir ano de <?= $ano; ?>"><img src="templates/portalTRF5/images/arrow_down_2.svg" alt="Abrir conteúdo"></a></li>
                </ul>
            </div>
            <div class="row botoes w100">
                <a href="#conteudo" role="button" class="download" title="Baixar em PDF" onClick="javascript:baixarPDF(<?= $ano; ?>);">
                    ...
                    <table border=0>
                        ...
                        ?>
								...
								<ul>
									...
									<li class='arrow-down'><a href='#conteudo' role='button' title='Expandir ano de " . $categoria->category_title . "'><img src='/templates/portalTransparencia/images/arrow_down_2.svg' alt='Abrir conteúdo'></a></li>
								</ul>
							</div>
							<div class='row botoes w100'>"; ?>
                                <a href="#conteudo" role="button" class="download" title="Baixar em PDF" onClick="javascript:baixarPDF('<?= $categoria->category_alias; ?>');">
                                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                                    PDF
                                </a>
                                <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('<?= $categoria->category_alias; ?>', 'xml');" title="Baixar em XML">
                                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                                    XML
                                </a>
                                <a href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('<?= $categoria->category_alias; ?>', 'csv');" title="Baixar em CSV">
                                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                                    CSV
                                </a>
                                <a href="#conteudo" role="button" title="Imprimir" class="download" onClick="javascript:baixarDocumento('tabela_export_<?= $categoria->category_alias; ?>', 'export','<?= $categoria->category_title; ?>', this );">
                                    <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                                    IMPRIMIR
                                </a>
                        <?php echo "
