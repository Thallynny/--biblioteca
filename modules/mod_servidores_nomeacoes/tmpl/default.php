    ...
    <table id="tabela_<?= $ano; ?>">
        ...
        foreach ($list as $listDados) :
            ...
            if ($listDados['anoConcurso']  == $ano) :
                ...
                $texto .= " <td>
                                <a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$listDados['id']."', 'SV29', '".urlencode("Concuros e Seleções/Concursos de Servidores/NOMEAÇÕES/" . $listDados['descricao'])."')\">
