...
<div class="row report">
    <ul style="width: 100%;">
        ...
        <li class="arrow-down"><a title="Expandir a categoria: <?= $categoriaTemp ?>" href="#conteudo" role="button"><img src="templates/portalTRF5/images/arrow_down_2.svg" alt="Abrir conteúdo"></a></li>
    </ul>
</div>
<?php 
} ?>
<div class="row botoes w100" style="display: none;">
    <a title="Baixar em PDF" href="#conteudo" role="button" class="download" onClick="javascript:baixarPDF('<?php echo $artigo->catid."_".$categoriaTemp; ?>')">
        <div class=" icone"><img src="templates/portalTRF5/images/download.svg"></div>
        PDF
    </a>
    <a title="Imprimir"  href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('<?php echo $artigo->catid."_".$categoriaTemp; ?>', 'export', '<?= $categoriaTemp; ?>', this)">
