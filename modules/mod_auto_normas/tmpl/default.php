            ...
            <div class="row botoes w100">
                ...
                <table id="tabela_atos">
					...
					$texto .= "<tbody>
								<tr>
								<td>
									<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $ato['id'] . "', 'SV44', '" . urlencode("PJE/NORMAS/" . $ato['descricaoNorma']) . "')\">
                ...
                <table id="tabela_lei">
					...
					foreach($dados['responseLei'] as $lei){
						...
						$texto .= "<tbody>
									<tr>
									<td>
										<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $lei['id'] . "', 'SV45', '" . urlencode("PJE/NORMAS/" . $lei['descricaoNorma']) . "')\">
            ...
            <div class="row botoes w100">
                ...
                <table id="tabela_portaria">
					...
					$texto .= "<tbody>
								<tr>
								<td>
									<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $portaria['id'] . "', 'SV46', '" . urlencode("PJE/NORMAS/" . $portaria['descricaoNorma']) . "')\">
            ...
            <div class="row botoes w100">
                ...
                <table id="tabela_provimento">
					...
					$texto .= "<tbody>
								<tr>
								<td>
									<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $provimento['id'] . "', 'SV47', '" . urlencode("PJE/NORMAS/" . $provimento['descricaoNorma']) . "')\">
            ...
            <div class="row botoes w100">
                ...
                <table id="tabela_resolucao">
					...
					$texto .= "<tbody>
								<tr>
								<td>
									<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $resolucao['id'] . "', 'SV48', '" . urlencode("PJE/NORMAS/" . $resolucao['descricaoNorma']) . "')\">
