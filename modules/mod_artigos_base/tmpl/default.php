...
//Regra para escolhe segunda aba quando for acesso o pje
if(strpos($_SERVER["REQUEST_URI"], "acesso-pje")){
echo "	<script>
...
<div class="container demonstrativo bg_azul_fundo">
    <div class="row conteudo selecionado">
        <div class="col-12">
			...
			<a href="#conteudo"  title="Baixar em PDF" role="button" class="download" onClick="javascript:gerarPDFGrande('<?php echo $list[0]->id;?>')">
                <div class=" icone"><img src="templates/portalTRF5/images/download.svg">
                </div>
                PDF
            </a>
			<?php else: ?>
			<a href="#conteudo"  title="Baixar em PDF" role="button" class="download" onClick="javascript:baixarPDF('export')">
                <div class=" icone"><img src="templates/portalTRF5/images/download.svg">
                </div>
                PDF
            </a>
            ...
            <a href="#conteudo" title="Imprimir" role="button" class="download" onClick="javascript:baixarDocumento('export', 'export', '<?= $titulo ?>', this)">
...
<div class="container demonstrativo bg_azul_fundo">
    <div class="row">
        <div class="col-md-6 aba selecionado aba1" data-aba="1">
            <div><a title="Abrir <?= $listTabs[0] ?>" class="textoSemSublinhado" href="#container"><?= $listTabs[0] ?></a></div>
        </div>
        <div class="col-md-6 aba aba2" data-aba="2">
            <div><a title="Abrir <?= $listTabs[1] ?>" class="textoSemSublinhado" href="#container"><?= $listTabs[1] ?></a></div>
        </div>
    </div>
    <div class="row conteudo selecionado aba01" data-aba-id="1">
        <div class="col-12">
            <div class="row">
            ...
            <div class="<?php echo getClass(getTextoExibicao($listArticlesByCategory[0])); ?>" style="display:block">
                ...
                <?php if ($exibirOpcao == "1") { ?>
                <a href="#conteudo" title="Baixar em PDF" role="button" class="download" onClick="javascript:baixarPDF('export0')">
                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                    PDF
                </a>
                <a href="#conteudo" title="Imprimir"  role="button" class="download" onClick="javascript:baixarDocumento('export0', 'export', '<?= $listTitles[0] ?>', this)">
                    <div class=" icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                    IMPRIMIR
                </a>
                <?php 
    ...
    <div class="row conteudo aba02" data-aba-id="2">
        <div class="col-12">
            <div class="row">
            ...
            <div class="<?php echo getClass(getTextoExibicao($listArticlesByCategory[1])); ?>" style="display:block">
                ...
                <?php if ($exibirOpcao == "1") { ?>
                <a title="Baixar em PDF" href="#conteudo" role="button" class="download" onClick="javascript:baixarPDF('export1')">
                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                    PDF
                </a>
                <a href="#conteudo"  title="Imprimir" role="button" class="download" onClick="javascript:baixarDocumento('export1', 'export', '<?= $listTitles[1] ?>', this)">
                    <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                    IMPRIMIR
                </a>
                <?php 
...
<div class="container demonstrativo bg_azul_fundo">
    <div class="row">
        <div class="col-md-4 aba selecionado aba1" data-aba="1">
            <div><a title="Abrir <?= $listTabs[0] ?>" class="textoSemSublinhado" href="#container"><?= $listTabs[0] ?></a></div>
        </div>
        <div class="col-md-4 aba aba2" data-aba="2">
            <div><a title="Abrir <?= $listTabs[1] ?>" class="textoSemSublinhado" href="#container"><?= $listTabs[1] ?></a></div>
        </div>
        <div class="col-md-4 aba aba3" data-aba="3">
            <div><a title="Abrir <?= $listTabs[2] ?>" class="textoSemSublinhado" href="#container"><?= $listTabs[2] ?></a></div>
        </div>
    </div>
    <div class="row conteudo selecionado aba01" data-aba-id="1">
        <div class="col-12">
            ...
            <?php if ($exibirOpcao == "1") { ?>
            <a  title="Baixar em PDF" href="#conteudo" role="button" class="download" onClick="javascript:baixarPDF('export2')">
                <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                PDF
            </a>
            <a  title="Imprimir" href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('export2', 'export', '<?= $listTitles[1] ?>', this)">
                <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                IMPRIMIR
            </a>
            <?php 
    ...
    <div class="row conteudo  aba02" data-aba-id="2">
        <div class="col-12">
            ...
            <div class="<?php echo getClass(getTextoExibicao($listArticlesByCategory[1])); ?>" style="display:block">
                ...
                <?php if ($exibirOpcao == "1") { ?>
                <a title="Baixar em PDF"  href="#conteudo" role="button" class="download" onClick="javascript:baixarPDF('export3')">
                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                    PDF
                </a>
                <a  title="Imprimir" href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('export3', 'export', '<?= $listTitles[1] ?>', this)">
                    <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                    IMPRIMIR
                </a>
                <?php 
    ...
    <div class="row conteudo  aba03" data-aba-id="3">
        <div class="col-12">
            <div class="row">
            ...
            <div class="<?php echo getClass(getTextoExibicao($listArticlesByCategory[2])); ?>" style="display:block">
                ...
                <?php if ($exibirOpcao == "1") { ?>
                <a  title="Baixar em PDF" href="#conteudo" role="button" class="download" onClick="javascript:baixarPDF('export4')">
                    <div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
                    PDF
                </a>
                <a  title="Imprimir" href="#conteudo" role="button" class="download" onClick="javascript:baixarDocumento('export4', 'export', '<?= $listTitles[2]; ?>', this)">
                    <div class="icone"><img src="templates/portalTRF5/images/impressora.svg"></div>
                    IMPRIMIR
                </a>
                <?php 
