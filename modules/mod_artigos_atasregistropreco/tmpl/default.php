...
<div class="row conteudo selecionado" data-aba-id="1">
	<div class="col-12">
		<div class="row">
			<div class="titulo">ATAS DE REGISTRO DE PREÇO</div>
		</div>
		<div class="row">
		...
		?>
				<div class="row report">
					<ul>
						...
						<li class="arrow-down"><a title="expandir <?php echo $horarioAno; ?>" href="#conteudo"><img src="templates/portalTRF5/images/arrow_down_2.svg"></a></li>
					</ul>
				</div>
				<div class="row botoes w100">
					<div class="boxBotoes">
						<a title="Baixar em PDF" href="#conteudo" class="download" onClick="javascript:baixarPDF(<?= $ano; ?>, 'pdf');">
							<div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
							PDF
						</a>
						<a title="Baixar em CSV" href="#conteudo" class="download" onClick="javascript:baixarDocumento(<?= $ano; ?>, 'csv');">
							<div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
							CSV
						</a>
						<a title="Baixar em XML" href="#conteudo" class="download" onClick="javascript:baixarDocumento(<?= $ano; ?>, 'xml');">
							<div class="icone"><img src="templates/portalTRF5/images/download.svg"></div>
							XML
						</a>
						<a title="Imprimir" href="#conteudo" class="download" onClick="javascript:baixarDocumento('tabela_export_<?= $ano; ?>', 'export', '', this);">
					...
					<div class="spacer"></div>
					<table id="tabela_<?= $ano; ?>" width="100%">
						<thead>
							<tr>
								<th>Ata</th>
								<th>Publicação</th>
							...
							foreach ($list as $listDados) :
								...
								if ($horarioAno2 == $horarioAno) :
									...
									foreach ($listDados['atas'] as $listaAtas) :
										$texto .= "
											<td>
												<a title='Link para: ".$listaAtas['descricao']."' href='#conteudo' onclick=\"exibirArquivo('../gestao-orcamentaria/resultado-pdf', '". $listaAtas['id'] . "', 'SV19', '" . urlencode("PORTAL DA TRANSPARÊNCIA/LICITAÇÕES E CONTRATOS/ATAS DE REGISTRO DE PREÇOS/" . $listDados['ano'] . "/" . retiraBarras($listaAtas['descricao'])) . "')\">
													" . $listaAtas['descricao'] . "
												</a>
											</td> ";
									endforeach;
