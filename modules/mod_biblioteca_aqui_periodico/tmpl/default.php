...
if(!empty($_GET['pagina'])){
			...
			foreach($list['return'] as $atas){
				...
				echo  "<a role='img' href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$atas['id']."', 'SV36', '".urlencode("BIBLIOTECA/Novas Aquisições/LIVROS/".$atas['volumePublicacao'])."')\">
