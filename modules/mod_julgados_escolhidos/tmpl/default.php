                ...
                <table id="tabela_<?= $ano; ?>">
					...
					$texto .= "<tbody>
							<tr>
								...
								<td>
									<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$listDados['id']."', 'SV34', '".urlencode("JURISPRUDÊNCIA/JULGADOS ESCOLHIDOS/" . $listDados['descricaoJulgado'])."')\" >
