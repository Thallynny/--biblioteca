                ...
                foreach ($list['dadosTratados'] as $art){
                    ...
                    <ul>
						...
						$anoPublic =  explode("/",$arr2['dataPublicacao']);
							if($ano == $anoPublic[2]){  			?>
							<li>
								<a href="#conteudo" onclick="exibirArquivo('index.php/gestao-orcamentaria/resultado-pdf', '<?php echo $arr2['id']; ?>', 'SV40', '<?php echo urlencode('CORREGEDORIA/ESTATÍSTICA/'.$anoPublic[2].'/'.$arr2['descricaoRevista']); ?>')" >
