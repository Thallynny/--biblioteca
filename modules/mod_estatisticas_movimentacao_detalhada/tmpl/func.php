	...
	if(is_array($arr)){
		...
		foreach($arr as $arrMes){
			if(empty( $arrMes['descricaoAnexo'])){
				$arrMes  = $arr;
				echo "<a  style='width: 60%;text-align: center;text-decoration: none;' class='box box-col-3'  href='#conteudo' onclick=\"exibirArquivo('".$url_link."index.php/gestao-orcamentaria/resultado-pdf', '".$arrMes['id']."', '".$dados['params']['servico_pdf']."', '".urlencode($dados['params']['titulo_tab_1']."/" . $arrMes['descricaoAnexo'])."')\">
