									...
									<?php
										...
										foreach ($listRevistasComemorativaTemp as $listDados) {
											...
											if ($horarioAno2[2] == $ano) {
												$texto .= "<li>
											<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$listDados['id']."', 'SV31', '".urlencode("GABINETE REVISTA/JURISDIÇÃO - PUBLICAÇÕES/REVISTAS")."')\">
											" . $listDados['descricao'] . "
											</a></li>
												";
											}
