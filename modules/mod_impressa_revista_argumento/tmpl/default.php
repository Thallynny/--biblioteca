					...
					<div class="row">
						...
						foreach($list as $listDados){
							...
							if($horarioAno[2] == $anoRevista[2]){
								$ano = $anoRevista[2]; ?>
								<div class="col-3">
									<?php echo  "<a  href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$listDados['id']."', 'SV33', '".urlencode("IMPRENSA/Revista Argumento/".$listDados['nomeArquivo'])."')\">
