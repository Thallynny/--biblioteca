...
<div class="container demonstrativo bg_azul_fundo">
	<div class="row conteudo" data-aba-id="2">
		<div class="col-12">
						...
						<ul>";
							...
							foreach ($ano as $desc) {
								if (is_array($desc)) {
									...
									$botao .= "<li><a title='" . $index2 . " - " . trim($arrayDesc[0]) . "' href='#conteudo' class='box' onClick=\"exibirArquivo('../gestao-orcamentaria/resultado-pdf', '" . $desc['id'] . "', 'SV18', '" . urlencode("GESTÃO ORÇAMENTÁRIA/GESTÃO - DEMONSTRATIVOS E RELATÓRIOS/RELATÓRIOS/" . $list['descricao'] . "/" . $anoTemp . "/" . trim($arrayDesc[1])) . "')\" >" . $index2 . " - " . trim($arrayDesc[0]) . "</a></li>";
									$index2++;
								}
							}
			...
			?>
								<li><a title="Abrir <?php echo $listaRelatorio['descricao']; ?>" href="#conteudo " class="textoSemSublinhado" onClick="exibirArquivo('../gestao-orcamentaria/resultado-pdf', '<?php echo $listaRelatorio['id']; ?>', 'SV18', '<?php echo urlencode("GESTÃO ORÇAMENTÁRIA/GESTÃO - DEMONSTRATIVOS E RELATÓRIOS/RELATÓRIOS/" . $list['descricao'] . "/" . $listaRelatorio['ano'])   ?>')"><?php echo $listaRelatorio['descricao']; ?></a></li>
			<?php
							}
							echo "</ul></div>";
						}
	...
	<div class="row conteudo selecionado" data-aba-id="1">
		...
		<div id="posiciona2" style="display:none;">
			<div id="fechar" style="display: flex; justify-content: space-between;">
				...
				<div align=rigth>
					<a href="javascript:fechar();" title="Fechar">FECHAR</a>
				</div>
			</div>
		...
		<div class="col-12">
			<div class="row boxes">
				<a href="#container" class="box textoSemSublinhado selecionado" onclick="exibirSecaoDemostrativoOrcamentario('trf5','<?php echo $WService; ?>', '0')" title="Mostrar dados do TRF5">TRF5</a>
				<a href="#container" class="box textoSemSublinhado" onclick="exibirSecaoDemostrativoOrcamentario('jfal','<?php echo $WService; ?>', '0')" title="Mostrar dados de Alagoas">Alagoas</a>
				<a href="#container" class="box textoSemSublinhado" onclick="exibirSecaoDemostrativoOrcamentario('jfce','<?php echo $WService; ?>', '0')" title="Mostrar dados do Ceará">Ceará</a>
				<a href="#container" class="box textoSemSublinhado" onclick="exibirSecaoDemostrativoOrcamentario('jfpb','<?php echo $WService; ?>', '0')" title="Mostrar dados da Paraíba">Paraíba</a>
				<a href="#container" class="box textoSemSublinhado" onclick="exibirSecaoDemostrativoOrcamentario('jfpe','<?php echo $WService; ?>', '0')" title="Mostrar dados de Pernambuco">Pernambuco</a>
				<a href="#container" class="box textoSemSublinhado" onclick="exibirSecaoDemostrativoOrcamentario('jfrn','<?php echo $WService; ?>', '0')" title="Mostrar dados do Rio Grande do Norte">Rio Grande do Norte</a>
				<a href="#container" class="box textoSemSublinhado" onclick="exibirSecaoDemostrativoOrcamentario('jfse','<?php echo $WService; ?>', '0')" title="Mostrar dados de Sergipe">Sergipe</a>
				<div class="clearfix"></div>
			</div>
			<div style="display:none;">
				<input type="text" id="WService" value="<?php echo $WService; ?>" />
				<input type="text" id="idMesOcultar" value="vazio" />
				<input type="text" id="idCategoria" value="0" />
			</div>
