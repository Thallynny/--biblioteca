...
if(strlen($nome) <= 10){
	echo utf8_encode("<font color='red'>Por favor preencher um NOME v�lido.</font>");
	exit;
}
...
if($tipoDocumento == "RG"){
	if($numeroDocumento == ""){
		echo utf8_encode("<font color='red'>Preencha o n�mero do documento.</font>");
		exit;
	}
}
...
if($tipoDocumento == "TITULO_ELEITOR"){
	...
	if(!validateTituloEleitor( $numeroDocumento )){
		echo utf8_encode("<font color='red'>T�tulo de eleitor inv�lido</font>");
		exit;
	}
}
...
if($tipoDocumento == "CPF"){
	...
	if(!valida_cpf( $numeroDocumento )){
		echo utf8_encode("<font color='red'>CPF inv�lido</font>");
		exit;
	}
}
...
if($tipoDocumento == "CNH"){
	...
	if(!validateCnh( $numeroDocumento )){
		echo utf8_encode("<font color='red'>CNH inv�lido</font>");
		exit;
	}
}
...
try {
	...
	echo utf8_encode("<font color='red'>Dados n�o foram salvos com sucesso!</font>");
}
