            ...
            <div class="row botoes w100" style="display: block;">
                ...
                <table id="tabela_<?= $ano; ?>">
					...
					$texto .= "<tbody>
							<tr>
								<td>
									<a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $manual['id'] . "', '".$dados['params']['servico_pdf']."', '" . urlencode("PJE/MANUAL/" . $manual['descricao']) . "')\">
                                        " . $manual['descricao'] . "
                                    </a>
