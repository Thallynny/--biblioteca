	 ...
	 $dados["dados"] = [
      ...
      'titulo_box_3' => $params->get('titulo_box_3')
		...
		try {
			...
			$responseTermoCessaoUso = json_decode(json_encode($client->getRelatorioContratacaoDireta()), True);

			$dados["listaContratacaoDireta"] = $responseTermoCessaoUso;
