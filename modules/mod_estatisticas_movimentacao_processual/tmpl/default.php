        ...
        <div class="col-12">
            ...
            <div class="row botoes w100 pt-3" style="display: none;">
                ...
                foreach (getAnexosVara($list['varas']) as $dado):
                    echo "<a style='width: calc(25% - 10px);text-align: center;text-decoration: none;' class='box box-col-4' href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$dado['id']."', 'SV38', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/PRIMEIRO GRAU/MOVIMENTAÇÃO PROCESSUAL - 2008-2014/Processos distribuídos, julgados, arquivados e em tramitação na 5ª Região - 2008 a 2014/Por Vara/".$dado['vara'])."')\">
                        ".$dado['vara']."
                        </a>";
                endforeach; 
                ?>
            ...
            <div class="row botoes w100 pt-3" style="display: none;">
                ...
                foreach (getAnexosSecoesTotais($list['secoes']) as $dado):
                    echo "<a style='width: calc(25% - 10px);text-align: center;text-decoration: none;' class='box box-col-4' href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$dado['id']."', 'SV39', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/PRIMEIRO GRAU/MOVIMENTAÇÃO PROCESSUAL - 2008-2014/Estatísticas Totais Gerais - 2008 a 2014/Resumo da 5ª Região - Processos distribuídos, julgados, arquivados e em tramitação/".renomearDescricao($dado['descricao']))."')\" >
                ...
                foreach (getAnexosSecoesGraficos($list['secoes']) as $dado):
                    echo "<a style='width: calc(25% - 10px);text-align: center;text-decoration: none;' class='box box-col-4' href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$dado['id']."', 'SV39', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/PRIMEIRO GRAU/MOVIMENTAÇÃO PROCESSUAL - 2008-2014/Gráficos - 2008 a 2014/Resumo da 5ª Região - Gráficos de Processos/".renomearDescricao($dado['descricao']))."')\">
                        ".renomearDescricao($dado['descricao'])."
                        </a>";
                endforeach; 
                ?>
