                ...
                <table id="tabela_<?= $ano; ?>">
                    ...
                    <tbody>
                        ...
                        foreach ($listDados as $concurso) :
                            ...
                            $texto .= "<td>
                                        <a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$concurso['id']."', 'SV30', '".urlencode("Concuros e Seleções/Concursos de Servidores/CONCURSO DE MAGISTRADOS/" . $concurso['tituloConcurso'] . "/" . $concurso['descricao'])."')\">
                                            " . $concurso['descricao'] . "
                                        </a>
                                    </td> ";
                            $texto .= "<tr>";
