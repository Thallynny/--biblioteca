                    ...
                    if (!empty($dado['semestral'][0])) {
                        ...
                        foreach ($dado['semestral'][0] as $anexo) {
                            if (!is_array($anexo)) {
                                ...
                                if ($anexoTemp != $anexo) {
                                    $tabelasRow .= "<a style='text-align: center;text-decoration: none;' class='box box-col-3 col-12' href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$anexo['id']."', 'SV37', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/SEGUNDO GRAU/" . $dado['ano'] . "/" . $anexo['descricao'])."')\"  >";
                    ...
                    if (!empty($dado['semestral'][1])) {
                        ...
                        foreach ($dado['semestral'][1] as $anexo) {
                            ...
                            if (!is_array($anexo)) {
                                ...
                                $tabelasRow .= "<a style='text-align: center;text-decoration: none;' class='box box-col-3 col-12' 
                                href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$anexo['id']."', 'SV37', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/SEGUNDO GRAU/" . $dado['ano'] . "/" . $anexo['descricao'])."')\">";
                                $tabelasRow .= $anexo['descricao'] . "</a>";
                            }
                        }
                        $tabelasRow .= "</div><div class='space'></div><div class='clearfix'></div>";
                        ...
                        if (!is_array($anexo)) {
                            ...
                            if ($anexoTemp != $anexo) {
                                ...
                                //if ($anexo['semestre'] != "jca" && $anexo['semestre'] != "1" && $anexo['semestre'] != "2") {
                                    $tabelasRow .= "<a style='text-align: center;text-decoration: none;' class='box box-col-3 col-12' href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$anexo['id']."', 'SV37', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/SEGUNDO GRAU/" . $dado['ano'] . "/" . $mes['descricaoMes'] . "/" . $anexo['descricao'])."')\">";
                                    $tabelasRow .= $anexo['descricao'] . "</a>";
                                }
                            }
                            $anexoTemp = $anexo;
                            ...
                            if($anexo['semestre'] == "est"){
                            //if ($anexo['semestre'] != "jca" && $anexo['semestre'] != "1" && $anexo['semestre'] != "2") {
                                $tabelasRow .= "<a style='text-align: center;text-decoration: none;' class='box box-col-3 col-12' href='#conteudo' onclick=\"exibirArquivo('/index.php/gestao-orcamentaria/resultado-pdf', '".$anexo['id']."', 'SV8', '".urlencode("PROCESSOS E CONSULTAS/ESTATÍSTICAS/SEGUNDO GRAU/" . $dado['ano'] . "/" . $mes['descricaoMes'] . "/" . $anexo['descricao'])."')\">";
                                $tabelasRow .= $anexo['descricao'] . "</a>";
                            }
                        }
                    endforeach;
