			...
			<div class="row">
                <div class="col-2">
                    <div class="searchlbox">
                        <img src="/templates/portalTransparencia/images/lupa.svg" alt="imagem para Portal da transparencia">
                ...
                <div class="col-9 consultacontainer">
                    ...
                    <div class="box">
						...
						foreach($buscaGuiadaServico as $retorno){
							foreach($retorno->categoria as $botoes){
								if(is_object($botoes)){ ?>
								<div class="box" onclick="javascript:resultadoBuscaGuiada('<?php echo $botoes->path; ?>','concursos-e-selecoes','<?php echo $botoes->nivel; ?>')";>
									<img src="/templates/portalTransparencia/images/folha.svg" alt="imagem para folha">
	...
	if($id_categoria == "resultado"){	?>	
			<div class="row">
                ...
                <div class="col-9 consultacontainer">
					...
					<div class="option margin">
                        <div class="chevron volta" onclick="javascript:resultadoBuscaGuiada('0','concursos-e-selecoes','concursos-e-selecoes')";><</div>
                        Escolha uma opção
                    </div>
