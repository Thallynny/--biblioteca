...
$dados = ModBuscaGuiadaConcursos::getDadosWebService($params, $arg0, $origem, $nivel);

require JModuleHelper::getLayoutPath('mod_busca_guiada_concursos', $params->get('layout', 'default'));
