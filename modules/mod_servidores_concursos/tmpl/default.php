        ...
        <tbody>
			...
			krsort($listDados);
                ...
                if ($listDados['anoConcurso'] == $ano2) {
                    ...
                    $texto .= " <td>
                                            <a href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '".$listDados['id']."', 'SV28', '".urlencode("Concuros e Seleções/Concursos de Servidores/CONCURSOS/" . $listDados['descricao'])."')\">
												" . $listDados['descricao'] . "
											</a>
										</td> ";
                    $texto .= "<tr>";
