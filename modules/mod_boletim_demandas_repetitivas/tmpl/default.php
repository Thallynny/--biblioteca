        ...
        if ($ano_lista != $dado['ano']) {
            ...
            foreach ($dados['dadosTratado2'] as $mes) {
                if ($dado['ano'] == $mes['ano']) {
                    ...
                    $tabelasRow .= "<a style='text-align: center;text-decoration: none;' class='box box-col-3 col-12' href='#conteudo' onclick=\"exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '" . $mes['id_doc'] . "', 'SV58', '" . urlencode("JURISPRUDÊNCIA/GESTÃO DE PRECEDENTES/" . $mes['ano'] . "/" . $mes['mes'] . "/" . $mes['descricao']) . "')\">";
