...
<div class="atualizacoes">
	...
	<?php foreach ($list as $item) : ?>
		...
		<a title="Acesse a notícia completa: <?php echo $item['titulo']; ?>" href="index.php/noticias/leitura-de-noticias?/id=<?= $item['id']; ?>">
			<div class="box_upd teste">
				<div class="data" style="color: #292b2c;"><?= $date->format('d.m.Y'); ?> às <?= $date->format('H:i') ?></div>
				<div class="titulo" style="font-size: 0.875rem;" ><?= substr($item['titulo'], 0, 110); echo tamanhoFontBotao($item['titulo']); ?></div>
				<div class="descricao">
