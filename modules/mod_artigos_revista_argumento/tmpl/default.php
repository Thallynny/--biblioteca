							...
							if($horarioAno2 == $horarioAno):
								foreach($listDados['editais'] as $listaRevista):
									if($listaRevista['exibe'] == "true"){
										...
										$texto .= "
										<a href='#' onclick=\"('../index.php/gestao-orcamentaria/resultado-pdf', '".$listaRevista['codigo']."', 'SV24', '".urlencode("IMPRENSA/Revista Argumento/".$horarioAno2."/".retiraBarras($listaRevista['descricaoArquivo']))."')\">
