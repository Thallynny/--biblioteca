...
$arg0 = (!empty($_GET['arg0'])) ? $_GET['arg0'] : "corregedoria";
...
$titleInput = "Digite um texto sobre o assunto que deseja encontrar na Corregedoria";
...
if ($nivel == "resultado") {	?>
	...
	<div class="row">
		<div class="col-12 consultacontainer">
			<div class="box mt-2">
				Não foi possível carregar a consulta geral, <a href="#" onclick="javascript:resultadoBuscaGuiada('corregedoria','1','0','avancar')" title="Tente Novamente">Tente novamente</a>.
						...
						foreach ($retorno->categoria as $botoes) {
							if (is_object($botoes)) {
								if (!empty($botoes->link) && $botoes->link != "") {
									$link = str_replace("corregedoria/", "", $botoes->link);
					?>
									<li class="left">
								...
								<?php } else { ?>
									<li class="left">
										<button title="Link para <?php echo $botoes->title; ?>" class="box noborder" onclick="javascript:resultadoBuscaGuiada('<?php echo $botoes->id; ?>','<?php echo "corregedoria/" . $botoes->id; ?>','<?php echo $nivel + 1; ?>','','<?php echo $botoes->title; ?>', 'avancar')" ;>
											<?php echo getTitle($botoes->title); ?>
										</button>
									</li>
					<?php }
...
?>
	...
	<div class="row">
		<div class="col-2">
			<div class="searchlbox">
				<?php echo utf8_encode("Corregedoria"); ?>
			</div>
		</div>
		<div class="col-10 consultacontainer">
			<button title="Fechar" class="fecha" onClick="fecharBuscaGuiada();">
