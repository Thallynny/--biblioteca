                    ...
                    foreach ($retornos as $retorno) {
                        ...
                        if (isset($retorno->categoria)) {
                            if (is_object($retorno->categoria)) {
                                ...
                                $link = str_replace("corregedoria/", "", $pesquisa->link); ?>
                                <li class="left w100">
                            ...
                            if (is_object($retorno->conteudo)) {
                                ...
                                if (!empty($pesquisa->sv) && $pesquisa->sv != "") { ?>
                                    <li class="left w100">
                                        <button title="Link para <?php echo $pesquisa->title; ?>" class="box noborder <?php echo getTamanho($pesquisa->title); ?>" onClick="exibirArquivo('../index.php/gestao-orcamentaria/resultado-pdf', '<?php echo $pesquisa->id; ?>', '<?php echo $pesquisa->sv; ?>', '<?php echo $origem; ?>')">
                                            <?php echo getTitle($pesquisa->title); ?>
                                        </button>
                                    </li>
                                <?php
