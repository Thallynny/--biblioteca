...
$dados = ModBuscaGuiadaCorregedoria::getDadosWebService($params, $arg0, $origem, $nivel);

require JModuleHelper::getLayoutPath('mod_busca_guiada_corregedoria', $params->get('layout', 'default'));
