...
<head>
    ...
    <title>Portal TRF5 - Concursos e Seleções</title>
...
<body>
    ...
    <div class="container hidemobile">
        <div class="row topo">
            ...
            <div class="col-md-6 text-right acessibilidade">
                ...
                <img src="<?= $pathIMG; ?>acessibilidade_ap.svg" class="btnFontMais" alt="Aumentar a letra">
                <img src="<?= $pathIMG; ?>acessibilidade_am.svg" class="btnFontMenos" alt="Diminuir a letra">
                <img src="<?= $pathIMG; ?>acessibilidade_c.svg" class="btnDaltonismo" alt="Contraste">
                <img src="<?= $pathIMG; ?>acessibilidade_back.svg" class="btnVoltarNormal" alt="Voltar ao Normal">
    ...
    <?php if (
        strpos($_SERVER['REQUEST_URI'], "concursos-e-selecoes") != false ||
        strpos($_SERVER['REQUEST_URI'], "concursos-selecoes") != false
    ) : ?>
        ...
        <div class="container" id="Inicio_Conteudo" name="Inicio_Conteudo">
            <div class="row pagina">
                ...
                <div class="col-md-8 col-sm-12 text-center titulo">
                    <img src="templates/portalInstitucional/images/olho.svg">
                    <span>PORTAL CONCURSOS E SELEÇÕES</span>
                </div>
        ...
        <div class="menu_expandido">
            <div class="container">
                <jdoc:include type="modules" name="midMenuConcursos" style="none" />
                <div class="clearfix"></div>
            </div>
        </div>
    <?php else : ?>
        ...
        <div class="container">
            <div class="row pagina">
                ...
                <div class="col-2 buscafield">
                    <div class="inner-addon">
                        <i class="fa fa-search" aria-hidden="true"></i>
                        <input type="text" class="form-control" placeholder="Consultar por" id="inputPesquisa" />
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row" style="position: relative;">
                        <div class="box fullwidth h158 align-self-center" style="position: relative">
                            ...
                            <a href="#Inicio_Conteudo" target="_self"><span style="color:#ffffff" title="Acessar o Conteúdo da Página">Conteúdo Principal&nbsp;&nbsp;</span></a>
                                ...
                                <div id="barraIdiomasInferior" class="hidemobile" style="display:none; color: #fff; margin-right:9px ; font-size: 0.625rem; "> <a style="color:#ffffff" href="javascript:trocarIdioma('en')">Inglês</a> / <a style="color:#ffffff" href="javascript:trocarIdioma('es')">Espanhol</a> / <a style="color:#ffffff" href="javascript:trocarIdioma('pt')">Português</a> <br>A tradução não é de responsabilidade do TRF5. </div>
                            </div>
                        </div>
                    </div>
                </div>
