$(document).ready(function(){
	...
	$('#portalTransparenciaBuscaGuiada').on('click', function(){
		...
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=conciliacao&origem=1&nivel=0&params=0&tituloNiveis="+encodeURI('Portal da Transpar\u00eancia')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});
		
	$('#consultaGestaoOrcamentaria').on('click', function(){
		var WService = document.getElementById('webService').value;
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=11&origem=conciliacao/11&nivel=1&params=0&tituloNiveis="+encodeURI('GEST\u00c3O OR\u00c7AMENT\u00c1RIA')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});

	$('#consultaLicitacaoContratacao').on('click', function(){
	var WService = document.getElementById('webService').value;
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=13&origem=conciliacao/13&nivel=1&params=0&tituloNiveis="+encodeURI('LICITA\u00c7\u00d5ES E CONTRATA\u00c7\u00d5ES')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});

	$('#convencioAcordos').on('click', function(){
	var WService = document.getElementById('webService').value;
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=15&origem=conciliacao/15&nivel=1&params=0&tituloNiveis="+encodeURI('CONV\u00caNIOS E ACORDOS')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});

	$('#gestaoPatrimonial').on('click', function(){
	var WService = document.getElementById('webService').value;
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=16&origem=conciliacao/16&nivel=1&params=0&tituloNiveis="+encodeURI('GEST\u00c3O PATRIMONIAL')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});

	$('#gestaoPessoas').on('click', function(){
	var WService = document.getElementById('webService').value;
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=18&origem=conciliacao/18&nivel=1&params=0&tituloNiveis="+encodeURI('GEST\u00c3O DE PESSOAS')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});

	$('#governaTI').on('click', function(){
	var WService = document.getElementById('webService').value;
		$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=19&origem=conciliacao/19&nivel=1&params=0&tituloNiveis="+encodeURI('GOVERNAN\u00c7A EM TI')+"&sentido=avancar&WService="+encodeURI(WService)+"");
	});
...
var WService = document.getElementById('webService').value;
 	$('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada_conciliacao/tmpl/default.php?arg0="+encodeURI(arg0)+"&origem="+encodeURI(origem)+"&nivel="+nivel+"&params="+params+"&tituloNiveis="+encodeURI(tituloNiveis)+"&sentido="+encodeURI(sentido)+"&WService="+encodeURI(WService)+"");
...
function resultadoBuscaGeral(WService, arg0, origem, nivel, termobusca, pagina, limite) {
    ...
    if(termobusca == ''){
        ...
        $('.resultadoBuscaGeral').html(img).load("../modules/mod_busca_guiada_conciliacao/tmpl/pesquisaGeral.php?arg0=" + encodeURI(arg0) + "&origem=" + encodeURI(origem) + "&nivel=" + nivel + "&limite=" + limite + "&pagina=" + pagina + "&WService=" + encodeURI(WService) + "&termobusca=" + encodeURI(termobusca));
    }
