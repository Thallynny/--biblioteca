...
<head>
    ...
    <title>Portal TRF5 - Conciliação</title>
...
<body>
    ...
    <?php if (in_array($_SERVER['PATH_INFO'], array('/conciliacao', '/conciliacao-land'))) : ?>
        <div class="container">
            <div class="row pagina">
                ...
                <div class="col-md-8 col-sm-12 text-center titulo">
                    ...
                    <span>PORTAL DA CONCILIAÇÃO</span>
                </div>
        ...
        <!-- BANNER CONCILIACAO -->
        <jdoc:include type="modules" name="bannerConciliacao" style="none" />

        <div class="container" id="Inicio_Conteudo" name="Inicio_Conteudo">
            <jdoc:include type="modules" name="midMenuConciliacao" style="none" />
        </div>
    <?php else : ?>
