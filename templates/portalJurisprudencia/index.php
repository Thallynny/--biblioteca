...
<head>
    ...
    <title>Portal TRF5 - Jurisprudência</title>
...
<body>
    ...
    <div class="container hidemobile">
        <div class="row topo">
            ...
            <div class="col-md-6 text-right acessibilidade">
                ...
                <img class="btnFontMais" src="<?= $pathIMG; ?>acessibilidade_ap.svg" alt="Aumentar Letra">
                <img class="btnFontMenos" src="<?= $pathIMG; ?>acessibilidade_am.svg" alt="Diminuir Letra">
    ...
    <?php if (
        strpos($_SERVER['REQUEST_URI'], "jurisprudencia-home") != false ||
        strpos($_SERVER['REQUEST_URI'], "jurisprudencia") != false
    ) : ?>
        ...
        <div class="container" id="Inicio_Conteudo" name="Inicio_Conteudo">
            ...
            <div class="row pagina">
                ...
                <div class="col-md-8 col-sm-12 text-center titulo">
                    <img src="templates/portalJurisprudencia/images/olho.svg">
                    <span>PORTAL DA JURISPRUDÊNCIA</span>
                </div>
        ...
        <!-- MENU MID JURISPRUDENCIA -->
        <div class="menu_expandido">
            <div class="container">
                <jdoc:include type="modules" name="midMenuJurisprudencia" style="none" />
                <div class="clearfix"></div>
            </div>
        </div>
    <?php else : ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                    <div class="row">
                        ...
                        <a class="botao box small links c1" style="font-weigth:bold; font-size: 1.5625rem; width: 252px; text-decoration: none;" target="_blank" href="https://www.trf5.jus.br/index.php/sei">sei!</a>
                    </div>
                    <div class="row">
