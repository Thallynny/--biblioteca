...
function gerarPDFGrande(id){
	window.open("index.php/gerar-pdf-grande?/id="+id, 'Download');  
	//location.href= "index.php/gerar-pdf-grande?/id="+id;
	
	var delay=5000; 
	setTimeout(function(){
		href='/modules/mod_pdf_grande/tmpl/relatorio.pdf';
