...
<head>
    ...
    <title>Portal TRF5 - Institucional</title>
...
<body>
    ...
    <?php if (in_array($_SERVER['PATH_INFO'], array('/institucional'))) : ?>
        ...
        <div class="container" id="Inicio_Conteudo" name="Inicio_Conteudo">
            ...
            <div class="row pagina">
                ...
                <div class="col-md-8 col-sm-12 text-center titulo" style="margin-top: -40px;">
        ...
        <div class="menu_expandido">
            <div class="container">
                <jdoc:include type="modules" name="midMenuInstitucional" style="none" />
                <div class="clearfix"></div>
            </div>
        </div>
    <?php else : ?>
