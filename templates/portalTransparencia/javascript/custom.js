$(document).ready(function () {
    ...
    $('#consultaGestaoEstrategica').on('click', function () {
        var WService = document.getElementById('webService').value;
        $('.resultadoBuscaGuiada').html("").load("../modules/mod_busca_guiada/tmpl/default.php?arg0=234&origem=portal-da-transparencia/234&nivel=1&params=0&tituloNiveis=" + encodeURI('GESTÃO ESTRATÉGICA') + "&sentido=avancar&WService=" + encodeURI(WService) + "");
    });
