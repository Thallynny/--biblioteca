 ...
 <body>
     ...
     <?php if (in_array($_SERVER['PATH_INFO'], array('/biblioteca'))) { ?>
         <div class="container">
             <div class="row pagina">
                 <div class="col-2">
                 </div>
                 <div class="col-md-8 col-sm-12 text-center titulo">
                     <img src="templates/portalBiblioteca/images/olho.svg">
     ...
     <!-- BANNER BIBLIOTECA -->
     <jdoc:include type="modules" name="bannerBiblioteca" style="none" />
     ...
     <div class="container" id="Inicio_Conteudo" class="Inicio_Conteudo">
         <jdoc:include type="modules" name="midMenuBiblioteca" style="none" />
             ...
             <div class="row">
                 ...
                 <div class="col-sm-12 col-md-9">
                     <div class="row">
                         ...
                         <a class="botao box small links c1" style="font-weigth:bold; font-size: 1.5625rem; width: 252px; text-decoration: none;" href="http://localhost/joomla/index.php/sei">sei!</a>
                     </div>
                     <div class="row">
                         <a class="botao box small c1 h72" target="_blank" href="https://www2.trf5.jus.br/ccheque/views/login.php">RECURSOS HUMANOS</a>
                         <a class="botao box small c1 h72" target="_blank" href="index.php/jornal-mural">JORNAL MURAL <br>DIARIO</a>
     ...
     <script src="<?= $pathJS; ?>tether.js?v=3"></script>
