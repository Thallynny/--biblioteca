    ...
    <div class="container hidemobile">
        <div class="row topo">
            ...
            <div class="col-md-6 text-right acessibilidade">
                ...
                <img src="<?= $pathIMG; ?>acessibilidade_ap.svg" id="btnFontMais" alt="Aumentar a letra">
                <img src="<?= $pathIMG; ?>acessibilidade_am.svg" alt="Diminuir a letra">
                <img src="<?= $pathIMG; ?>acessibilidade_c.svg" alt="Contraste">
                <img src="<?= $pathIMG; ?>acessibilidade_back.svg" alt="Voltar ao Normal">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="row">
                        <div class="botao box small sic white" onclick="window.location.href='index.php/ouvidoria'">SIC – Serviço de Informação ao Cidadão</div>
                    </div>
                </div>
