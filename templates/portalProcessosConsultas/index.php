 ...
 <head>
     ...
     <title>Portal TRF5 - Serviços</title>
 ...
 <body>
     ...
     <div class="container hidemobile">
         <div class="row topo">
             ...
             <div class="col-md-6 text-right acessibilidade">
                 ...
                 <img class="btnFontMais" src="<?= $pathIMG; ?>acessibilidade_ap.svg">
                 <img class="btnFontMenos" src="<?= $pathIMG; ?>acessibilidade_am.svg">
                 <img class="btnDaltonismo" src="<?= $pathIMG; ?>acessibilidade_c.svg">
                 <img class="btnVoltarNormal" src="<?= $pathIMG; ?>acessibilidade_back.svg">
     ...
     <div class="menu_exp" data-menu="1">
         <div class="container">
             <jdoc:include type="modules" name="menuItemProcessos" style="none" />
         </div>
         <div class="clearfix"></div>
     </div>

     <?php
        if (in_array($_SERVER['PATH_INFO'], array('/servicos'))) : ?>
         <div class="container">
     ...
     <?php if (
            strpos($_SERVER['REQUEST_URI'], "processos-consultas-home") != false ||
            strpos($_SERVER['REQUEST_URI'], "processos-e-consultas") != false
        ) : ?>
         <!-- MENU MID PROCESSOS E CONSULTAS -->
         <div class="menu_expandido">
             <div class="container">
                 <jdoc:include type="modules" name="midMenuProcessos" style="none" />
                 <div class="clearfix"></div>
             </div>
         </div>
     <?php else : ?>
