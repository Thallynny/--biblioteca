...
function resultadoBuscaGeral(WService, arg0, origem, nivel, termobusca, pagina, limite) {
    ...
    if(termobusca == ''){
        ...
        $('.resultadoBuscaGeral').html(img).load("../modules/mod_busca_guiada_servicos/tmpl/pesquisaGeral.php?arg0=" + encodeURI(arg0) + "&origem=" + encodeURI(origem) + "&nivel=" + nivel + "&limite=" + limite + "&pagina=" + pagina + "&WService=" + encodeURI(WService) + "&termobusca=" + encodeURI(termobusca));
    }
...
function exibirArquivo(link, id, sv, niveis){
    ...
    var caminhoForm = '../../../includes/formularioArquivo.php';
